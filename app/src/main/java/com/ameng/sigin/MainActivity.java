...
public class MainActivity extends AppCompatActivity implements
    ...
    private GoogleTokenAsyncTask task;
    @Override
...
// onConnected indicates that an account was selected on the device, that the selected
        ...
        if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
            ...
            if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
                GoogleTokenAsyncTask task = new GoogleTokenAsyncTask(this, accountName);
                task.execute();
            }
//            task.getGoogleTokenOnFinsh(new GoogleTokenAsyncTask.GoogleTokenOnFinsh() {
//                @Override
//                public void onGoogleTokenOnFinsh(String token) {
//                    Log.d(TAG, token + "");
//                }
//            });
